...
export default [
  { path: '', component: SettingsComponent,
    children: [
        ...
        // reusing the issuance form, and everyone past settingsGuard satisfies
        // AuthService.canAccessSettings() — the same predicate behind the sidenav
        // link, so the catalog is always both reachable and offered to them.
        ...
        // tenant-admin, which canAccessSettings() does not — the component handles 403.
        {
          path: 'catalog',
          loadComponent: () =>
